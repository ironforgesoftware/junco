...
const GRANDFATHERED_FUNCTION_LINES = [
  // `App` (1,883): #350 moved the action handlers out into src/tui/hooks/; what
  // is left is the nav spine plus the render body, whose section-by-section
  // extraction is still open under the sweep tracker #387. −30 from the 1,913
  ...
  // Task 4). The cascade, the verbs and the slash router live in
