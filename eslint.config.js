...
const GRANDFATHERED_FUNCTION_LINES = [
  // `App` (1,912): #350 moved the action handlers out into src/tui/hooks/; what
  // is left is the nav spine plus the render body, whose section-by-section
  // extraction is still open under the sweep tracker #387. +86 over the 1,826
  ...
  // binding-context branch, the scroll key + crumbs, the rail-switch effect and
  // its badge, and the render branch. The cascade, the verbs and the slash
  // router live in hooks/useChatInput.ts.
  { file: "src/tui/App.tsx", max: 1912 },
