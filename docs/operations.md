...
| `junco transcript <ticket-id\|path.jsonl> [--thinking] [--tools] [--width N] [--json]`                                                                     | Print a recorded event transcript — runs, turns, tool calls and results, the agent's answer (the dashboard opens the same view with `enter` on a queue row).                                                                                                                                                                   |
