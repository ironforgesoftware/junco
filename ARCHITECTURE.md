...
future push target. See `docs/bot-account.md`.
...
| `authCmd.ts`            | `junco auth login` — runs `runGhLogin` into the bot's isolated config dir, verifies via `detectBotLogin`, then flips `botAccount.enabled` in `config.json` (atomic temp+rename, same pattern as `configCmd`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
