...
| File                    | Responsibility                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| ----------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `cli.ts`                | Entrypoint; subcommands `start`, `run-once`, `submit`, `dispatch`, `inbox-path`, `status`, `list`, `retry`, `outbox`, `prs`, `assess`, `doctor`, `dashboard`, `logs`, `schema`, `init`, `service`, `restart`. Exposes testable `run(argv, deps)`.                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| `assessReview.ts`       | Durable pending-review store for `junco assess` — one JSON file per audit batch under `<state_dir>/assess-review/` (atomic tmp+rename, `watchlist.ts`/`githubOutbox.ts` discipline: missing → empty, corrupt → skipped + logged, never throws). `writePending`/`listPending`/`readPending`/`removePending` (archives to `assess-review/filed/` rather than deleting) / `pendingCount` (surfaced in `status`/`doctor`).                                                                                                                                                                                                                                                      |
...
| `statusCmd.ts`          | `junco status` — daemon /health + queue counts at a glance, plus the pending assess-review count (`assessReview.ts`) when non-zero.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| `doctor.ts`             | `junco doctor` — preflight config/toolchain/endpoint/model/dirs, plus the pending assess-review count when non-zero (informational, not a health problem).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
