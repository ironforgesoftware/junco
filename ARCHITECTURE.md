...
| `tui/`                  | Ink dashboard (fullscreen workspace): theme/layout/window foundations, pure state derivation, gh client seam, queue snapshot, geometry + SGR mouse codec + hit-test resolver + useMouse, links (OSC 8), components, App.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
